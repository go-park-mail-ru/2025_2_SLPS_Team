...
func TestFriendService_SendFriendRequest(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		authService.EXPECT().IsUserExists(ctx, &pb.UserIDRequest{UserId: 2}).Return(&pb.UserExistsResponse{Exists: true}, nil)
	...
	t.Run("Friend not found", func(t *testing.T) {
		authService.EXPECT().IsUserExists(ctx, &pb.UserIDRequest{UserId: 2}).Return(&pb.UserExistsResponse{Exists: false}, nil)
		err := svc.SendFriendRequest(ctx, 1, 2)
		assert.ErrorIs(t, err, domain.ErrNotExist)
	})

	t.Run("DB error on get user", func(t *testing.T) {
		authService.EXPECT().IsUserExists(ctx, &pb.UserIDRequest{UserId: 2}).Return(nil, errors.New("dbconn"))
		err := svc.SendFriendRequest(ctx, 1, 2)
...
func TestFriendService_GetFriends(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		friendStore.EXPECT().GetUserFriends(ctx, 1, 10, 0).Return([]int32{2}, nil)
		profileService.EXPECT().GetShortProfileByUserIDs(ctx, &pb.GetShortProfileByUserIDsRequest{UserIDs: []int32{2}}).Return(&pb.GetShortProfileByUserIDsResponse{Profiles: []*pb.ShortProfile{{UserID: 2}}}, nil)
	...
	t.Run("Default pagination", func(t *testing.T) {
		friendStore.EXPECT().GetUserFriends(ctx, 1, 20, 0).Return([]int32{2}, nil)
		profileService.EXPECT().GetShortProfileByUserIDs(ctx, &pb.GetShortProfileByUserIDsRequest{UserIDs: []int32{2}}).Return(&pb.GetShortProfileByUserIDsResponse{Profiles: []*pb.ShortProfile{{UserID: 2}}}, nil)
	...
	t.Run("Profile service error", func(t *testing.T) {
		friendStore.EXPECT().GetUserFriends(ctx, 1, 10, 0).Return([]int32{2}, nil)
		profileService.EXPECT().GetShortProfileByUserIDs(ctx, &pb.GetShortProfileByUserIDsRequest{UserIDs: []int32{2}}).Return(nil, errors.New("profile error"))
		res, err := svc.GetFriends(ctx, 1, domain.PaginateQueryParams{Limit: 10, Page: 1})
		assert.ErrorIs(t, err, domain.ErrDB)
		assert.Nil(t, res)
	})
...
func TestFriendService_GetAllUsers(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		friendStore.EXPECT().GetAllUsers(ctx, 1).Return([]int32{2, 3}, nil)
		profileService.EXPECT().GetOtherShortProfileByUserIDs(ctx, &pb.GetOtherShortProfileByUserIDsRequest{UserIDs: []int32{2, 3}, Limit: 10, Offset: 0}).Return(&pb.GetOtherShortProfileByUserIDsResponse{Profiles: []*pb.ShortProfile{{UserID: 2}}}, nil)
	...
	t.Run("Default pagination", func(t *testing.T) {
		friendStore.EXPECT().GetAllUsers(ctx, 1).Return([]int32{2, 3}, nil)
		profileService.EXPECT().GetOtherShortProfileByUserIDs(ctx, &pb.GetOtherShortProfileByUserIDsRequest{UserIDs: []int32{2, 3}, Limit: 20, Offset: 0}).Return(&pb.GetOtherShortProfileByUserIDsResponse{Profiles: []*pb.ShortProfile{{UserID: 2}}}, nil)
	...
	t.Run("DB error", func(t *testing.T) {
		friendStore.EXPECT().GetAllUsers(ctx, 1).Return(nil, errors.New("dbconn"))
		res, err := svc.GetAllUsers(ctx, 1, domain.PaginateQueryParams{Limit: 10, Page: 1})
		assert.ErrorIs(t, err, domain.ErrDB)
		assert.Nil(t, res)
	})
...
func TestFriendService_GetFriendRequests(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		friendStore.EXPECT().GetFriendshipRequests(ctx, 1, 10, 0).Return([]int32{2}, nil)
		profileService.EXPECT().GetShortProfileByUserIDs(ctx, &pb.GetShortProfileByUserIDsRequest{UserIDs: []int32{2}}).Return(&pb.GetShortProfileByUserIDsResponse{Profiles: []*pb.ShortProfile{{UserID: 2}}}, nil)
	...
	t.Run("Default pagination", func(t *testing.T) {
		friendStore.EXPECT().GetFriendshipRequests(ctx, 1, 20, 0).Return([]int32{2}, nil)
		profileService.EXPECT().GetShortProfileByUserIDs(ctx, &pb.GetShortProfileByUserIDsRequest{UserIDs: []int32{2}}).Return(&pb.GetShortProfileByUserIDsResponse{Profiles: []*pb.ShortProfile{{UserID: 2}}}, nil)
...
func TestFriendService_GetSentRequests(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		friendStore.EXPECT().GetSentRequests(ctx, 1, 10, 0).Return([]int32{2}, nil)
		profileService.EXPECT().GetShortProfileByUserIDs(ctx, &pb.GetShortProfileByUserIDsRequest{UserIDs: []int32{2}}).Return(&pb.GetShortProfileByUserIDsResponse{Profiles: []*pb.ShortProfile{{UserID: 2}}}, nil)
	...
	t.Run("Default pagination", func(t *testing.T) {
		friendStore.EXPECT().GetSentRequests(ctx, 1, 20, 0).Return([]int32{2}, nil)
		profileService.EXPECT().GetShortProfileByUserIDs(ctx, &pb.GetShortProfileByUserIDsRequest{UserIDs: []int32{2}}).Return(&pb.GetShortProfileByUserIDsResponse{Profiles: []*pb.ShortProfile{{UserID: 2}}}, nil)
...
func TestFriendService_CountUserRelations(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		authService.EXPECT().IsUserExists(ctx, &pb.UserIDRequest{UserId: 1}).Return(&pb.UserExistsResponse{Exists: true}, nil)
		friendStore.EXPECT().CountUserRelations(ctx, 1).Return(&domain.UserRelationsCounts{
			Accepted: 5,
			Pending:  3,
			Sent:     2,
			Blocked:  1,
		}, nil)
		counts, err := svc.CountUserRelations(ctx, 1)
		assert.NoError(t, err)
	...
	t.Run("User not found", func(t *testing.T) {
		authService.EXPECT().IsUserExists(ctx, &pb.UserIDRequest{UserId: 1}).Return(&pb.UserExistsResponse{Exists: false}, nil)
		counts, err := svc.CountUserRelations(ctx, 1)
		assert.ErrorIs(t, err, domain.ErrNotExist)
		assert.Nil(t, counts)
	})
	...
	t.Run("DB error on get user", func(t *testing.T) {
		authService.EXPECT().IsUserExists(ctx, &pb.UserIDRequest{UserId: 1}).Return(nil, errors.New("dbconn"))
		counts, err := svc.CountUserRelations(ctx, 1)
		assert.ErrorIs(t, err, domain.ErrDB)
		assert.Nil(t, counts)
	})
	...
	t.Run("DB error on count relations", func(t *testing.T) {
		authService.EXPECT().IsUserExists(ctx, &pb.UserIDRequest{UserId: 1}).Return(&pb.UserExistsResponse{Exists: true}, nil)
		friendStore.EXPECT().CountUserRelations(ctx, 1).Return(nil, errors.New("dbconn"))
		counts, err := svc.CountUserRelations(ctx, 1)
		assert.ErrorIs(t, err, domain.ErrDB)
		assert.Nil(t, counts)
	})
...
func TestFriendService_SearchShortProfilesByFullNameAndRelationType(t *testing.T) {
	...
	t.Run("Success with terms", func(t *testing.T) {
		friendStore.EXPECT().GetUserIDsByFriendType(ctx, 1, domain.CountAccepted).Return([]int32{2, 3}, nil)
		elasticProfileStore.EXPECT().SearchUserIDsByFullNameWithFilter(ctx, "John", []int32{2, 3}, true, 10, 0).Return([]int32{2}, nil)
		profileService.EXPECT().GetShortProfileByUserIDs(ctx, &pb.GetShortProfileByUserIDsRequest{UserIDs: []int32{2}}).Return(&pb.GetShortProfileByUserIDsResponse{Profiles: []*pb.ShortProfile{{UserID: 2}}}, nil)

		res, err := svc.SearchShortProfilesByFullNameAndRelationType(ctx, 1, domain.PaginateQueryParams{Limit: 10, Page: 1}, "John", domain.CountAccepted)
		assert.NoError(t, err)
		assert.Len(t, res, 1)
	})

	t.Run("Success without terms", func(t *testing.T) {
		friendStore.EXPECT().GetUserIDsByFriendType(ctx, 1, domain.CountNotFriends).Return([]int32{2, 3}, nil)
		elasticProfileStore.EXPECT().SearchUserIDsByFullNameWithFilter(ctx, "John", []int32{2, 3}, false, 10, 0).Return([]int32{2}, nil)
		profileService.EXPECT().GetShortProfileByUserIDs(ctx, &pb.GetShortProfileByUserIDsRequest{UserIDs: []int32{2}}).Return(&pb.GetShortProfileByUserIDsResponse{Profiles: []*pb.ShortProfile{{UserID: 2}}}, nil)

		res, err := svc.SearchShortProfilesByFullNameAndRelationType(ctx, 1, domain.PaginateQueryParams{Limit: 10, Page: 1}, "John", domain.CountNotFriends)
		assert.NoError(t, err)
		assert.Len(t, res, 1)
	})

	t.Run("DB error on get user IDs", func(t *testing.T) {
		friendStore.EXPECT().GetUserIDsByFriendType(ctx, 1, domain.CountAccepted).Return(nil, errors.New("dbconn"))
	...
	t.Run("DB error on elastic search", func(t *testing.T) {
		friendStore.EXPECT().GetUserIDsByFriendType(ctx, 1, domain.CountAccepted).Return([]int32{2, 3}, nil)
		elasticProfileStore.EXPECT().SearchUserIDsByFullNameWithFilter(ctx, "John", []int32{2, 3}, true, 10, 0).Return(nil, errors.New("elastic error"))
...
func TestFriendService_EdgeCases(t *testing.T) {
	...
	t.Run("Empty results", func(t *testing.T) {
		friendStore.EXPECT().GetUserFriends(ctx, 1, 10, 0).Return([]int32{}, nil)
	...
	t.Run("Multiple friends", func(t *testing.T) {
		friendStore.EXPECT().GetUserFriends(ctx, 1, 10, 0).Return([]int32{2, 3, 4}, nil)
		profileService.EXPECT().GetShortProfileByUserIDs(ctx, &pb.GetShortProfileByUserIDsRequest{UserIDs: []int32{2, 3, 4}}).Return(&pb.GetShortProfileByUserIDsResponse{Profiles: []*pb.ShortProfile{
...
func TestFriendService_PaginationEdgeCases(t *testing.T) {
	...
	t.Run("Zero limit - should use default limit (20)", func(t *testing.T) {
		friendStore.EXPECT().GetUserFriends(ctx, 1, 20, 0).Return([]int32{}, nil)
		profileService.EXPECT().GetShortProfileByUserIDs(ctx, &pb.GetShortProfileByUserIDsRequest{UserIDs: []int32{}}).Return(&pb.GetShortProfileByUserIDsResponse{Profiles: []*pb.ShortProfile{}}, nil)
	...
	t.Run("Large page number", func(t *testing.T) {
		friendStore.EXPECT().GetUserFriends(ctx, 1, 10, 90).Return([]int32{}, nil)
		profileService.EXPECT().GetShortProfileByUserIDs(ctx, &pb.GetShortProfileByUserIDsRequest{UserIDs: []int32{}}).Return(&pb.GetShortProfileByUserIDsResponse{Profiles: []*pb.ShortProfile{}}, nil)
